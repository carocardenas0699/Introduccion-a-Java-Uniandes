...
public class Urna
{
    ...
    {
    	return ((double) candidato1.darVotosInfluenciaInternet() / calcularTotalVotosInternet( ))*100;
    }
    ...
    {
    	return ((double) candidato2.darVotosInfluenciaInternet() / calcularTotalVotosInternet( ))*100;
    }
